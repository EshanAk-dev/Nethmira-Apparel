...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1><i class="fa-regular fa-square-plus"></i>&nbsp;&nbsp;Add New Color</h1>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  </section>
            ...
            <form action="" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" required value="{{ old('name') }}" placeholder="Enter color name">
                </div>
