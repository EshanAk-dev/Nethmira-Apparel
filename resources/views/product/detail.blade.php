    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url($getProduct->getCategory->slug.'/'.$getProduct->getSubCategory->slug) }}">
    ...
    <div class="page-content">
                    ...
                    <div class="col-md-6">
                        <div class="product-gallery">
                            <figure class="product-main-image">
                                ...
                                <img id="product-zoom" src="{{ $getProductImage->getProductImage() }}" data-zoom-image="{{ $getProductImage->getProductImage() }}" alt="product image">
                            ...
                            <div id="product-zoom-gallery" class="product-image-gallery">
                                ...
                                <a class="product-gallery-item" href="#" data-image="{{ $image->getProductImage() }}" data-zoom-image="{{ $image->getProductImage() }}">
                                    <img src="{{ $image->getProductImage() }}" alt="product side">
                                </a>
                                @endforeach
                        ...
                        <div class="product-details">
                          ...
                          {{--  <div class="ratings-container">
                            ...
                            <div class="product-price">
                                Rs. <span id="getTotalPrice">{{ number_format($getProduct->price, 2) }}</span>
                            ...
                            <form action="{{ url('product/add-to-cart') }}" method="post">
                                    ...
                                    <div class="select-custom">
                                        <select name="size_id" id="size" required class="form-control getSizePrice">
                                            ...
                                            <option data-price="{{ !empty($size->price) ? $size->price : 0 }}" value="{{ $size->id }}">{{ $size->name }} @if(!empty($size->price))
                                                (Rs.{{ number_format($size->price,2) }}) @endif
                                            </option>
                                            @endforeach
                                        </select>
                                    </div><!-- End .select-custom -->
                                ...
                                <div class="details-filter-row details-row-size">
                                    ...
                                    <div class="product-details-quantity">
                                        <input type="number" id="qty" name="qty" class="form-control" value="1" min="1" max="50" required step="1" data-decimals="0">
                            ...
                            <div class="product-details-footer">
                                <div class="product-cat">
                                    ...
                                    <a href="{{ url($getProduct->getCategory->slug.'/'.$getProduct->getSubCategory->slug) }}">
                                        {{ $getProduct->getSubCategory->name }}</a>
                                </div><!-- End .product-cat -->
        ...
        <div class="container">
            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                ...
                @endphp
                <div class="product product-7" style="border-radius: 5%;">
                    <figure class="product-media" style="border-radius: 5%;">
                        <a href="{{ $value->slug }}">
                            @if(!empty($getProductImage) && !empty($getProductImage->getProductImage()))
                            <img style="height: 280px; width: 100%; object-fit: cover;" src="{{ $getProductImage->getProductImage() }}" alt="{{ $value->title }}" class="product-image">
                            @endif
                        </a>
                        ...
                        <div class="product-action-vertical">
                            ...
                            title="Wishlist" id="{{ $value->id }}"><span>add to wishlist</span></a>
                            @else
