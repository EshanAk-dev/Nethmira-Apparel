	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="{{ $getSystemSettingApp->getFooterLogo() }}" class="footer-logo" alt="Footer Logo" 
									width="120" height="40">
	            		...
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
									@if(empty(Auth::check()))
	            						<li><a href="#signin-modal" data-toggle="modal">Login / Signup </a></li>
									@endif
	            					<li><a href="{{ url('cart') }}">View Cart</a></li>
									@if(!empty(Auth::check()))
	            						<li><a href="{{ url('my-wishlist') }}">My Wishlist</a></li>
									@else
										<li><a href="#signin-modal" data-toggle="modal">My Wishlist</a></li>
									@endif
